    ...
    <div id="document-content">
        ...
        <section class="col-xs-9">
            ...
            <div>
                ...
                <div>
                    <table>
                        <tr style="background: #fff;"><td>应用名称</td><td>应用名称，将显示在商店和用户桌面图标下</td></tr>
                        <tr><td>应用简介</td><td>应用的描述、介绍，显示在应用详情页面。</td></tr>
                        <tr><td>应用图标</td>
                            <td>
                                <p>图标，显示在商店和用户桌面。图标标准规范：</p>
                                <ul>
                                    <li>图标背景色为单色系，8px圆角;</li>
                                    <li>图标主体图形为纯色图形，40px*40px，#FFFFFF;</li>
                                    <li>图标储存为png格式，24位色透明底，68px*68px;</li>
                                    <li>图标图形设计含义必须符合应用名称。</li>
                                </ul>
                            </td>
                        </tr>
