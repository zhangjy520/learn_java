...
<style>
    ...
    .Validform_checktip{width:auto !important;font-size:12px !important; position:absolute;left:376px;top:2px;}
</style>
<!--注册流程-->
<div class="container find-pwd validform" id="find-pwd-1">
    ...
    <div class="find-box" id="f-email-check" style="position:relative;">
        ...
        <div style="position:relative;">
            <span>确认密码：</span>
            <input type="password" recheck="newPassword" datatype="*" errormsg='您两次输入的密码不一致，请重试' id="confirmNewPassword"/>
        </div>
        <p class="validTip" style=""></p>
...
//        datatyp:{"zh6-20":/^[\u4E00-\u9FA5\uf900-\ufa2d]{6,20}$/}
    ...
    $("#submit-PWD").click(function () {
        ...
        $.post("${ctx}/pwd/update", {
            ...
            if (data.code == 0) {
                webToast("修改成功", "top", 2000);
            } else if (data.code == 1) {
                webToast("修改失败", "top", 2000);
            }
        });
    })
</script>
