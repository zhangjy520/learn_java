    ...
    <div id="document-content">
        ...
        <section class="col-xs-9">
            ...
            <c:if test="${openUser.status == 1}">
                <h1>开发者资料 <a href="#" class="rl">待审核</a></h1>
            </c:if>
                ...
                <form action="${ctx}/manager/updateInfo" method="post" id="submitFormPersonal" data-ajax='false'>
                    ...
                    <div>
                        <p>
                            ...
                            <input type="hidden" value="" class="forUpdatePersonal" name="personal.contactsPhone" id="phone"/>
                            <span>
                            <span></span>
                    ...
                    <div style="display: none" class="forUpdatePersonalDiv">
                        ...
                        <p>
                            <span></span>
                            <input type="text" name="cmbAddress" class="easyui-validatebox textbox"  data-options="required:true"  value="${sessionScope.personal.address}" id="address"/>
                        </p>
                    </div>
