                ...
                <div>
                    ...
                    <p style="display: none" class="forUpdatePersonalP">
                        ...
                        <input type="text" name="cmbAddress" class="easyui-validatebox textbox"
                               data-options="required:true" value="${sessionScope.personal.address}" id="address" style="height: 42px;"/>
                    </p>
                    </p>
                    <p>
                        <span>企业电话:</span>
                    ...
                    <p>
                        ...
                        <img alt="" id="wm6" width="100px" height="100px" src="${accessories.licenceScan}"
                             data-url="${accessories.identityPhoto}" style="vertical-align: top;border: 1px solid #ddd;"/>
                    </p>
                    <p>
                ...
                <div>
                    ...
                    <p style="height: 42px;">
                        ...
                        <span  style="height: 42px;">
                            <input type="button" style="display: none;width:180px;height: 42px;" class="forUpdate required" datatype="m" errormsg="请输入正确的手机号码"
                    ...
                    <p>
                        ...
                        <input type="hidden" placeholder="验证码为6位数字" id="codeInput"
                               value="" datatype="n6-6" errormsg="验证码错误" class="forUpdate required" style="height: 42px;"/>
                    </p>
                </div>
            </form>
            <p style="text-align: center; padding: 30px 0 15px 0;">
                <button onclick="spanHideAndInputShow()" id="btnForUpdate">修&nbsp;改</button>
                <button id="btnForSave" style="display: none;margin-right: 10px;" onclick="saveForUpdateInfo()" type="submit">提&nbsp;交</button>
