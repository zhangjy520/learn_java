...
public class Student implements Serializable {
    ...
    public String getXstz() {
        return xstz;
    }

    public void setXstz(String xstz) {
        this.xstz = xstz == null ? null : xstz.trim();
    }
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getBj() == null ? other.getBj() == null : this.getBj().equals(other.getBj()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getBj() == null) ? 0 : getBj().hashCode());
