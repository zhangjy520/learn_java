...
public class Role implements Serializable {
    ...
    public Integer getPermissionRange() {
        return permissionRange;
    }

    public void setPermissionRange(Integer permissionRange) {
    ...
    public boolean equals(Object that) {
        ...
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getPermissionRange() == null ? other.getPermissionRange() == null : this.getPermissionRange().equals(other.getPermissionRange()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getPermissionRange() == null) ? 0 : getPermissionRange().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", permissionRange=").append(permissionRange);
