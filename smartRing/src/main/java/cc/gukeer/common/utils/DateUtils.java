...
public class DateUtils {
    ...
    public static String formatStandardDate(long timestamp) {
        try {
    ...
    public static long dayStartTimestamp(long dayTimestamp) {
        long timestamp = 0l;
    ...
    public static long dayEndTimestamp(long dayTimestamp) {
        long timestamp = 0l;
    ...
    public static void main(String[] args) throws UnsupportedEncodingException, ParseException {
       ...
       long t = System.currentTimeMillis();
        ...
        long d1 = dayStartTimestamp(t);
        long d2 = dayEndTimestamp(t);

        String dd1 = formatStandardDate(t);
        String dd2 = formatStandardDate(d1);
        String dd3 = formatStandardDate(d2);
