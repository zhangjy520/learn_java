...
<body>
<form action="${ctx}/sport/stuScore/import" id="inputForm" method="post" enctype="multipart/form-data">
    <div class="container">
        <div>
        ...
        $.ajax({
            ...
            if (res.code == 0) {
                ...
                for (var i = 0; i < tem.length; i++) {
                    dataHtml += "<tr>" +
                            "<td>" + tem[i].data.test_id + "</td>" +
                            "<td>" + tem[i].data.item_name + "</td>" +
                            "<td>" + tem[i].data.create_date + "</td>" +
                            "<td>" + tem[i].data.stu_no + "</td>" +
                            "<td>" + tem[i].data.stu_mark + "</td>" +
                            "<td>" + tem[i].reason + "</td>" +
                            "</tr>";
                ...
                window.parent.layer.open({
                    ...
                    btn2: function () {
                        ...
                        form.attr("action","${ctx}/sport/score/error/export");
                        var input1=$("<input>");
