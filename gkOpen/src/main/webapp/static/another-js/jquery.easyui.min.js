...
$.fn.validatebox.defaults={required:false,validType:null,validParams:null,delay:200,missingMessage:"信息不能为空.",invalidMessage:null,tipPosition:"right",deltaX:0,novalidate:false,events:{focus:_444,blur:_448,mouseenter:_44c,mouseleave:_44f,click:function(e){
var t=$(e.data.target);
if(!t.is(":focus")){
t.trigger("focus");
}
}},tipOptions:{showEvent:"none",hideEvent:"none",showDelay:0,hideDelay:0,zIndex:"",onShow:function(){
$(this).tooltip("tip").css({color:"#FF2C36",borderColor:"#FF2C36",backgroundColor:"#fff"});
},onHide:function(){
$(this).tooltip("destroy");
...
},message:"请输入合法的邮箱"},url:{validator:function(_46f){
...
},message:/*"Please enter a valid URL."*/"请输入正确的URL地址"},length:{validator:function(_470,_471){
...
},message:"请输入{0} 到 {1}个字符."},remote:{validator:function(_472,_473){
var data={};
data[_473[1]]=_472;
