...
<main class="container">
        ...
        <section class="col-xs-9">
            <section id="app2" class="validform">
                ...
                <ul>
                    ...
                    <li>
                        <span>介绍:</span>
                        <textarea cols="53" rows="10" name="platform.introduce" style="resize: none;
                        border:1px solid #ddd;padding-left: 5px;" id="platformIntroduce">${platform.introduce}</textarea>
    ...
    <footer>
        <button id="platformAdd" onclick="updatePlatform()">保存</button>
    </footer>
</main>
