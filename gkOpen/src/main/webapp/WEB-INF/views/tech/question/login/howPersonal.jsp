...
<main class="container">
    <section id="tech-detail">
        ...
        <div class="tech-detail-article">
            ...
            <div>
                <p>2、用户注册时，在开发者类型中选择个人即可，按照系统提示的信息进行邮箱和密码的正确填写，确认无误后选择同意遵守教育云开放平台协议，点击下一步。</p>
                <img src="${ctx}/static/images/personalImg2.png">
            </div>
            <div>
                <p>3、系统自动向注册邮箱发送验证邮件，用户登录邮箱点击验证链接即可完成邮箱验证，完成后系统自动跳转到注册流程的下一步。若信息填写错误可以点击重新填写，进行修改验证邮箱的操作，若未收到验证邮件，请先检查邮箱的垃圾邮件中是否有验证邮件，若无可以点击重新发送，系统会自动重新发送验证邮件。</p>
                <img src="${ctx}/static/images/p3.png">
            </div>
            <div>
                <p>4、正确填写用户资料，确认无误后点击成为开发者即可，系统自动将用户信息提交到管理员处，由管理员对用户信息进行审核。</p>
                <img src="${ctx}/static/images/p4.png">
            </div>
            <div>
                <p>5、由平台管理员对注册信息进行审核，审核通过后用户即完成了注册流程，在审核过程中用户可以登录平台进行审核状态的查看。若审核未通过，用户需要对注册信息进行更改直至通过审核。</p>
            </div>
        </div>
    </section>
</main>
