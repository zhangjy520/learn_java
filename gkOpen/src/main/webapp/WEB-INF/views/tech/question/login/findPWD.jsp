...
<main class="container">
    <section id="tech-detail">
        ...
        <div class="tech-detail-article">
            ...
            <div>
                <p>1、进入网站首页，
                    点击右上角的“登陆”，再登陆框中点击“忘记密码”。</p>
                <img src="${ctx}/static/images/pwd1.png">
            </div>
            <div>
                <p>2、用户需要填写注册时的邮箱，系统将发送验证信息到邮箱。</p>
                <img src="${ctx}/static/images/pwd2.png">
            </div>
            <div>
                <p>3、用户登录邮箱进行验证，若邮箱填写错误可以点击重新填写，进行重填邮箱地址的操作，若邮件没有收到可以先查看一下邮箱的垃圾箱中是否有验证邮件，若没有可以点击重新发送，系统会重新发送验证邮件，用户进行验证即可。</p>
                <img src="${ctx}/static/images/pwd3.png">
            </div>
            <div>
                <p>4、验证成功后，用户即可重置密码，点击确定后即可生效。</p>
                <img src="${ctx}/static/images/pwd4.png">
            </div>
        </div>
    </section>
</main>
