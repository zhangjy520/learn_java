        ...
        <section id="content1">
            ...
            <ul class="massages">
                <li>
                    ...
                    <div>
                        <p style="width: 100px; height: 100px"><a onclick="window.open('${appInfo.app.logo}')"><img
                                style="width:100%; height: 100%" src="${appInfo.app.logo}" alt="aaa"></a></p>
                    </div>
                </li>
                <li>
                    ...
                    <div>
                        <ul class="gallery" style="width: 350px;">
                            <c:forEach items="${screenshotList}" var="screenshot">
                                <li><a onclick="window.open('${screenshot}')"><img src="${screenshot}" alt="应用截图"></a>
                                </li>
                            </c:forEach>
                        </ul>
                    </div>
