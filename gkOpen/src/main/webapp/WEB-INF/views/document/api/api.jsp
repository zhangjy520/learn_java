    ...
    <div id="document-content">
        ...
        <section class="col-xs-9">
            ...
            <div id="oauth">
                ...
                <h5>2.文档下载:</h5>
                <p><p style="color: #54ab37">Oauth2.0授权登录说明文档下载需要登陆后,点击首页右上角的【管理中心】-->【文档下载中心】进行下载</p></p>
                <p>注:若没有可点击的链接，请耐心等待注册信息审核，审核通过后才可以进入下载页下载，是否通过审核的状态可以通过登陆后，进入管理中心的【基本资料】进行查看，审核状态会显示在基本资料的右上角</p>
                <h5>3.步骤说明:</h5>
                <ul>
            ...
            <div id="dataSyncronism">
                ...
                <h5>2.文档下载:</h5>
                <p><p style="color: #54ab37">数据实时同步说明文档下载需要登陆后,点击首页右上角的【管理中心】-->【文档下载中心】进行下载</p></p>
                <p>注:若没有可点击的链接，请耐心等待注册信息审核，审核通过后才可以进入下载页下载，是否通过审核的状态可以通过登陆后，进入管理中心的【基本资料】进行查看，审核状态会显示在基本资料的右上角</p>
                <h5>3.文档目录结构说明:</h5>
                <ul>
