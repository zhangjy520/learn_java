    ...
    <div id="document-content">
        ...
        <section class="col-xs-9">
            ...
            <div class="tech-detail-article detial">
                ...
                <h4>二、填写基本信息</h4>
                <div>
                    <p>用户需要在开发者类型中进行选择，教育云开放平台支持个人和企业两种类型的开发者，按照系统提示的信息进行邮箱和密码的正确填写，确认无误后选择同意遵守教育云开放平台协议，点击下一步。</p>
                    <img src="${ctx}/static/images/personalImg2.png">
                </div>
                <h4>三、邮箱激活</h4>
                <div>
                    <p>系统自动向注册邮箱发送验证邮件，用户登录邮箱点击验证链接即可完成邮箱验证，完成后系统自动跳转到注册流程的下一步。若信息填写错误可以点击重新填写，进行修改验证邮箱的操作，若未收到验证邮件，请先检查邮箱的垃圾邮件中是否有验证邮件，若无验证邮件则可以点击重新发送，系统会自动重新发送验证邮件。</p>
                ...
                <h4>五、用户审核</h4>
                <div>
                    <p>由平台管理员对注册信息进行审核，审核通过后用户即完成了注册流程，在审核过程中用户可以登录教育云开放平台进行审核状态的查看。若审核未通过，用户需要对注册信息进行更改直至通过审核。</p>
                </div>
            </div>
        </section>
    </div>
