...
public abstract class BasicController extends LoggerWrapper {
    ...
    protected OpenUser getLoginUser() {
        Subject subject = SecurityUtils.getSubject();
        OpenUser user = (OpenUser) subject.getPrincipal();
    ...
    protected String getMailUrl (String userName) {
        String url = "http://www.2345.com/mail.htm";
        if (userName.contains("qq")) {
            url = "http://mail.qq.com";
        } else if (userName.contains("163")) {
            url = "http://mail.163.com";
        } else if (userName.contains("126")) {
            url = "http://mail.126.com";
        } else if (userName.contains("foxmail")) {
            url = "http://mail.foxmail.com";
