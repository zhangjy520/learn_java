...
$(function () {
	...
	$('.dropdown').click(function(){
		whichIsOpen=$(this).attr("class").replace("open","");
		$("."+whichIsOpen+">ul").attr("style","display:none !important");
		if($(this).find("ul").is(":hidden")){
			$(this).find("ul").attr("style","display:block !important");
		}else{
			$(this).find("ul").attr("style","display:none !important");
		}
	...
	$('.dropdown-menu>li>a').click(function(){
		className=$(this).parent().parent().parent().attr("class").replace("open","");
		$("."+className).children("a").attr("style","background:#fff !important");
		$(this).parent().parent().attr("style","display:none !important");
		$(this).parent().parent().parent().children("a").attr("style","color:#1ab394 !important");
		
	});
	
	$('.dropdown-menu>li>a').on('click',menuItem);//顶部菜单点击下方跳转。
