...
<button class="btn btn-white btn-sm" onclick="partCreate()" data-toggle="tooltip" data-placement="top"><i class="fa fa-plus"> ${label==null?'生成账号':label}</i>
                        </button>
...
$(document).ready(function() {
	...
	function partCreate(){
		...
		// var url = $(this).attr('data-url');
		  ...
		  top.layer.confirm('确认要将选中的账号进行生成操作?', {icon: 3, title:'系统提示'}, function(index){
