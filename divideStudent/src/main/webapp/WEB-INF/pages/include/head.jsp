...
<script src="${ctxStatic}/fb/main.js" type="text/javascript"></script>
<script src="${ctxStatic}/fb/fenBan.js" type="text/javascript"></script>
<link href="${ctxStatic}/fb/css/style.css" rel="stylesheet" type="text/css" />
<link href="${ctxStatic}/fb/css/fenBan.css" rel="stylesheet" type="text/css" />

<!--引入打印插件 -->
<script src="${ctxStatic}/fb/jquery.jqprint-0.3.js" type="text/javascript"></script>
