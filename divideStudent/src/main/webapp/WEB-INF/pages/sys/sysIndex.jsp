...
<body class="fixed-sidebar full-height-layout gray-bg">
    <div id="wrapper">
        ...
        <div class="row border-bottom white-bg special-bgForWhite">
			...
			<div class="navbar-collapse collapse" id="navbar">
                <ul class="nav navbar-nav">
                   <!--  <li class="active">
					...
					<t:menuHengxiang menu="${fns:getTopMenu()}"></t:menuHengxiang>
                </ul>
                <ul class="logOutA nav navbar-top-links navbar-right">
                    <li>
                        <a href="${ctx}/logout">
        ...
        <div id="page-wrapper" class="gray-bg dashbard-1">
            <%-- <div class="row border-bottom">
                <nav  style="display:none !important" class="navbar navbar-static-top" role="navigation" style="margin-bottom: 0">
           ...
           <%--  <div class="row content-tabs" style="display:none !improtant">
