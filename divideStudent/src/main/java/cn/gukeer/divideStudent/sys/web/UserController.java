...
import cn.gukeer.common.beanvalidator.BeanValidators;
...
import cn.gukeer.divideStudent.sys.service.SystemConfigService;
import cn.gukeer.divideStudent.sys.service.SystemService;
import cn.gukeer.divideStudent.sys.utils.UserUtils;
import cn.gukeer.divideStudent.common.utils.TwoDimensionCode;
...
public class UserController extends BaseController {
	...
	public String form(User user, Model model) {
        School queryObj = new School();
        queryObj.setCreateBy(user);
	    model.addAttribute("allSchool",schoolService.findList(queryObj));
