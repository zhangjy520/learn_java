...
import cn.gukeer.common.utils.PropertiesLoader;
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/gukeer.properties").getPath();
	...
	public static Properties getProperties(){
		...
		try {
			Reader reader = Resources.getResourceAsReader("/gukeer.properties");
			prop.load(reader);
		} catch (Exception e) {
			return null;
		}
