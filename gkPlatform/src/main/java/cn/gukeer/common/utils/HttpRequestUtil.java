...
public class HttpRequestUtil {
    ...
    public static void main(String[] args) {
        String urll="http://192.168.199.137:89/ssoLogin/auth";
        Map<String,String> aa=new HashMap<String, String>();
        aa.put("puid","406");
        aa.put("ptime","1476675240000");
        aa.put("pkey","886d6cb82ca11f54c7883db6f55f3cda");
        try {
           String aaa= post(urll,null,null,aa);
