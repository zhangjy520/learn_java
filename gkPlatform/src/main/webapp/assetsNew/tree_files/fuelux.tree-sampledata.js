...
var tree_data = {//一级菜单
	'栏目一' : {name: '栏目一', type: 'folder'}
//	'vehicles' : {name: 'Vehicles', type: 'folder'}	,
//	'rentals' : {name: 'Rentals', type: 'folder'}	,
//	'real-estate' : {name: 'Real Estate', type: 'folder'}	,
//	'pets' : {name: 'Pets', type: 'folder'}	,
//	'tickets' : {name: 'Tickets', type: 'item'}	,
//	'services' : {name: 'Services', type: 'item'},//同级菜单中没有子菜单的项
//	'personals' : {name: 'Personals', type: 'item'}
}
tree_data['栏目一']['additionalParameters'] = {//二级菜单
	'children' : {
		'栏目一' : {name: '栏目一', type: 'item'},
		'栏目二' : {name: '栏目二', type: 'item'},
		'栏目三' : {name: '栏目三', type: 'item'}
