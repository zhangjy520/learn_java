...
<div class="mainContain">
    <div class="forBeauty">
        ...
        <div class="mainClass" id="studentInfo">
            <div class="neiNian3">
                上次登录时间:<label>2012年4月23日</label>
            </div>
            <div class="neiNian4">
                <img src="${ctxStatic}/image/parents/jiazhangpic.png">
            </div>
            <div class="neiNian5">
                <p class="neiNian6">赵树坤&nbsp;<input type="button" value="家长" style="background-color:#24D3DE ;"
                                                    class="neiNian7"/>
                <p class="neiNian8">赵惠子的爸爸</p>
                </p>
            </div>
            <br>
            <div class="neiNian9">
            ...
            <div style="position:absolute;width: 280px;height:255px;border-top: 1px #d2d2ca solid;margin-top: 28px;">
                <ul style="list-style: none;padding-left: 18px;padding-right: 18px;margin: 0;">
                    <li style="line-height: 45px;font-size: 14px;color: #333333;height: 18%"><span
                            class="devideVer"></span>&nbsp;学生的班级
                    </li>
                    ...
                    <li style="font-size: 14px;color: #333333;height: 23%;">
                        <span class="devideVer"></span>&nbsp;学生的家长
                        <br><a style="line-height: 37px;font-size: 12px;color: #999999;">家长准入码：00102340627</a>
                    </li>
                    <li style="height: 35%;">
						<span style="display: inline-block;width: 40%;">
							<img src="${ctxStatic}/image/stu/zhaoshuk.png"/><p>赵树坤</p>
						</span>
                        <span style="display: inline-block;width: 40%;">
							<img src="${ctxStatic}/image/stu/liuyu.png"/><p>&nbsp;刘玉</p>
						</span>
                    </li>
            ...
            <div class="todayCourse" style="height: 355px;">
                <ul style="">
                    <li>
                        ...
                        <span>
							<img align="absmiddle" style="height: 100%;"
                                 src="${ctxStatic}s/image/todayCourseLine.png"/>
                    ...
                    <li>
                        ...
                        <span>
							<img align="absmiddle" style="height: 100%;"
                                 src="${ctxStatic}/image/todayCourseLine.png"/>
        ...
        <!--通知模块-->
        <div style="margin: -848px 303px;" class="withLine" id="publicStu">
            <div class="withLine1">
            ...
            <div class="withLine2 publicLi neiNian10Stu">
                <ul>
                    <li><p class="green publicText"><a class="normalCss">王启明老师布置了一项主题为“写作练笔”的作业</a><a
                            class="publicTime">5分钟前</a></p></li>
                    <li><p class="orange publicText"><a class="normalCss">王启明老师布置了一项熟读“夸父驻日”的作业</a><a
                            class="publicTime">1个小时前</a></p></li>
                    <li><p class="blue publicText"><a class="normalCss">王启明老师布置了一项练习“女娲补天”课后生词五遍的作业</a><a
                            class="publicTime">2014-1</a></p></li>
                    <li><p class="green publicText"><a class="normalCss">王启明老师布置了一项“8.3”课后习题的作业</a><a
                            class="publicTime">2011-1</a></p></li>
                    <li><p class="green publicText"><a class="normalCss">王启明老师布置了一项预习下节课的作业</a><a class="publicTime">2011-1</a>
                    </p></li>
                    <li><p class="green publicText"><a class="normalCss">王启明老师布置了一项抄写unit6前5段的作业</a><a
                            class="publicTime">2011-1</a></p></li>
                    <li><p class="green publicText"><a class="normalCss">王启明老师布置了一项熟读“女娲补天”的作业</a><a class="publicTime">2011-1</a>
                    </p></li>
                    <li><p class="green publicText"><a class="normalCss">刘月老师布置了一项抄写第六单元生词3遍的作业</a><a
                            class="publicTime">2011-1</a></p></li>
                    <li><p class="orange publicText"><a class="normalCss">李时珍布置了一项参观动物园观后感的作业</a><a class="publicTime">2011-5</a>
                    </p></li>
                    <li><p class="blue publicText"><a class="normalCss">王香香老师布置了一项完成”8.2“课后习题的作业</a><a
                            class="publicTime">1993-6</a></p></li>
        ...
        <!--天气模块-->
        <div style="margin: 314px 928px;" class="withLine" id="weatherStu">
            <div class="withLine1">
                <div class="withLineLeft ">今天</div>
                <div class="withLineRight neiNian12">2016年5月23日 星期一</div>
            </div>
            <div class="neiNian13"><img src="${ctxStatic}/image/weather.png"
                                        class="neiNian14"></div>
        ...
        <!--我的小伙伴模块 -->
        <div style="    margin: 579px 928px;" class="withLine" id="whatToDoStu">
            <div class="withLine1">
                <div class="withLineLeft ">授课教师</div>
                <div class="withLineRight" style="margin-right: 80px">|&nbsp;&nbsp;我的好友</div>
            </div>
            <div class="withLine2 myFriend ">
                <ul style="margin-top: 23px;">
                    <li>
                        <div class="daibanDiv">
                            <img class="headheadPicPic"
                                 src="${ctxStatic}/image/parents/wangqiming.png">
                            <div class="neiNian22Stu">
                                <a class="aForUnderLine neiNian23">王启明<a
                                        style="font-size: 14px;color: #24D3DE;">(语文)</a></a>
                                <br><a class="neiNian24">经验丰富/活跃/创新/激发</a>
                            </div>
                    ...
                    <li>
                        <div class="daibanDiv">
                            <img class="headheadPicPic"
                                 src="${ctxStatic}/image/parents/wangxiangxiang.png">
                            <div class="neiNian22Stu">
                                <a class="aForUnderLine neiNian23">王湘乡<a
                                        style="font-size: 14px;color: #24D3DE;">(数学)</a></a>
                                <br><a class="neiNian24">元老级/状元/快速/独特</a>
                            </div>
                    ...
                    <li>
                        <div class="daibanDiv">
                            <img class="headheadPicPic"
                                 src="${ctxStatic}/image/stu/lisi.png">
                            <div class="neiNian22Stu">
                                <a class="aForUnderLine neiNian23">李志林<a
                                        style="font-size: 14px;color: #24D3DE;">(英语)</a></a>
                                <br><a class="neiNian24">幽默/机智/严谨/有技巧</a>
                            </div>
                    ...
                    <li>
                        <div class="daibanDiv">
                            <img class="headheadPicPic"
                                 src="${ctxStatic}/image/parents/zhangshuxian.png">
                            <div class="neiNian22Stu">
                                <a class="aForUnderLine neiNian23">张淑贤<a
                                        style="font-size: 14px;color: #24D3DE;">(社会)</a></a>
                                <br><a class="neiNian24">风趣/开朗/热情/有特点</a>
                            </div>
                    ...
                    <li>
                        <div class="daibanDiv">
                            <img class="headheadPicPic"
                                 src="${ctxStatic}/image/parents/yaoxin.png">
                            <div class="neiNian22Stu">
                                <a class="aForUnderLine neiNian23">姚欣<a style="font-size: 14px;color: #24D3DE;">(科学)</a></a>
                                <br><a class="neiNian24">幽默/直观/简练/善于发现</a>
                            </div>
        ...
        <!-- 我的群组模块-->
        <div style="margin: 1036px 928px;" class="withLine" id="myCourseQz">
            <div class="withLine1">
            ...
            <div class=" withLine2 mycourseLiStu">
                <ul>
                    ...
                    <li>
                        <div class="neiNian34">
                            <div class="aForUnderLine">第五小组家长群
                            </div>
                        </div>
                    </li>
                    ...
                    <li>
                        <div class="neiNian34">
                            <div class="aForUnderLine">语文小组家长群
                            </div>
                        </div>
                    </li>
                </ul>
        ...
        <!--我的应用模块-->
        <div style="margin: 870px 302px;" class="withLine" id="myAppStu">
            <div class="withLine1">
            ...
            <table class="myAppTable" width="95%" height="75%">
                <tr class="myAppTr">
                    <td width="33%" class="myAppTdStu">
                        <img src="${ctxStatic}/image/parents/xiaokan.png">
                        <div class="neiNian20">
                            <a class="appTitle">校刊</a><br>
                    ...
                    <td width="33%" class="myAppTdStu">
                        <img src="${ctxStatic}/image/parents/wenjuan.png">
                        <div class="neiNian20">
                            <a class="appTitle">问卷调查</a><br>
                            <a class="appType">学生成长</a><br>
                            <a><img src="${ctxStatic}/image/star.png"></a>
                        </div>
                    </td>
                    ...
                    <td width="33%" class="myAppTdStu">
                        <img src="${ctxStatic}/image/parents/pingjia.png">
                        <div class="neiNian20">
                            <a class="appTitle">家长评价</a><br>
                            <a class="appType">学生成长</a><br>
                            <a><img src="${ctxStatic}/image/star.png"></a>
                        </div>
                    </td>
                ...
                <tr class="myAppTr">
                    ...
                    <td class="myAppTdStu">
                        <img src="${ctxStatic}/image/parents/huodong.png">
                        <div class="neiNian20">
                            <a class="appTitle">活动墙</a><br>
                            <a class="appType">学生成长</a><br>
                            <a><img src="${ctxStatic}/image/star.png"></a>
                        </div>
                    </td>
...
<%-- student and patriarch idnex page:<br/>
