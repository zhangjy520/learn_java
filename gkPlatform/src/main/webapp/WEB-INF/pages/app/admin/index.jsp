            ...
            <table>
                ...
                <c:forEach items="${pageInfo.list}" var="app" varStatus="status">
                    <tr>
                        <td>${app.name}</td>
                        <td>
                            <c:if test="${app.sfczxmz==0}"><img src="${ctx}/file/pic/show?picPath=${app.iconUrl}" width="100px" height="100px" /></c:if>
                            <c:if test="${app.sfczxmz==1}"><img src="${ctxStatic}/image/appDetails/${app.iconUrl}" width="100px" height="100px" /></c:if>
